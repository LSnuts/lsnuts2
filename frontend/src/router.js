...
const routes = [
  ...
  { path: '/forgot-password', component: () => import('./views/ForgotPassword.vue'), meta: { title: '忘记密码', requiresAuth: false } },
  { path: '/reset-password', component: () => import('./views/ResetPassword.vue'), meta: { title: '重置密码', requiresAuth: false } },
  ...
  { path: '/user/:id', component: () => import('./views/UserProfile.vue'), meta: { title: '用户主页', requiresAuth: false } },
